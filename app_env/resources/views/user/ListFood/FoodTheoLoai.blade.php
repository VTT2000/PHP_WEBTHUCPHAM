                      ...
                      <ul class="collection__filter-checkbox-list" role="list">
                          @foreach ($NhaSanXuats as $i)
                              ...
                              <li class="collection__filter-checkbox">
                                  <a href="<?php echo url('ListFood/FoodTheoNCC?id='.$i->IdNSX);?>" title=""><?php echo $i->TenNSX;?></a>
                              </li>
                          @endforeach
                    ...
                    <div class="collection__toolbar collection__toolbar--bordered">
                      <div class="collection__toolbar-item collection__toolbar-item--sort">
                        <div class="value-picker-wrapper">
                          ...
                          <button href1="<?php echo url('ListFood/FoodTheoLoai?sapxep=1&id='.$Id);?>" onclick="location.href = this.getAttribute('href1');" class="value-picker-button" type="button">
                            <span>Sắp xếp</span>
                          </button>
                        </div>
